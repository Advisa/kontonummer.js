...
;(function () {
    ...
    var getClearingNumber = function(bankNumber, bank) {
        return bankNumber.substr(0, bank.lengths.clearing);
    };

    var getAccountNumber = function(bankNumber, bank) {
        return bankNumber.substr(bank.lengths.clearing);
    };
    ...
    var fillZeros = function (accountNumber, bank) {
        var clearingNumber = getClearingNumber(accountNumber, bank);
        var numberWithoutClearing = getAccountNumber(accountNumber, bank);
